    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Обновляем категорию!</h2>
                    <span>Здесь мы будем обновлять категории</span>
                                   ...
                                   <div class="form-group">
                                       <div class="col-sm-12 right-side-group">
                                           ...
                                           <label title="Upload image file" for="inputImage2" class="btn btn-primary">
                                               <input type="file" name="wide_bg" id="inputImage2" class="hide">
                                               1920x600
                                           </label>
                                           ...
                                           <a href="{{ url( 'dashboard/category/delete', $data['id'] ) }}" class="btn btn-warning">Удалить</a>
                                           <div class="progress" >
    ...
    <script>
                    ...
                    $(document).ready(function() {
                        ...
                        $("#form").submit(function(event){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "{{ url( "dashboard/category/edit",$data['id'])  }}",
