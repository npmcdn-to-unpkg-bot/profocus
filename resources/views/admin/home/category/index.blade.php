...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-4">
            <h2>Категории</h2>
            <span>смотрим, обновляем, удаляем категории</span>
        </div>
        <div class="col-sm-8">
            <div class="title-action">
                <a href="{{ url('dashboard/category/new') }}" class="btn btn-primary btn-sm">Добавить</a>
            </div>
        </div>
    </div>
            ...
            <div class="wrapper wrapper-content animated fadeInRight">
                ...
                @foreach( $data as $post )
                    ...
                    <div class="faq-item">
                        <div class="row">
                            <div class="col-md-10">
                                <a href="{{ url('dashboard/category/edit',$post['id'] ) }}" class="faq-question">
                                    {{ $post['title'] }}
                                </a>
