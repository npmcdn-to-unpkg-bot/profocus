    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Обновляем страницу</h2>
                    <span>Здесь мы будем обновлять страницы</span>
                    <span class="back-to-list" style="display: none;"><a href="{{ url('/dashboard') }}"><b>Назад</b></a></span>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#form").submit(function(event){
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ url('dashboard/pages/edit', $data['id']) }}",
