    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-sm-8">
            <div class="title-action">
                <a href="{{ url('dashboard/equipment/new') }}" class="btn btn-primary btn-sm">Добавить</a>
            </div>
        </div>
    </div>
            ...
            <div class="wrapper wrapper-content animated fadeInRight">
                @foreach( $data as $post )
                    <div class="faq-item">
                        <div class="row">
                            <div class="col-md-10">
                                <a href="{{ url('dashboard/equipment/edit',$post['id'] ) }}" class="faq-question">
                                    {{ $post['title'] }}
                                </a>
                                Запись была создана {{ $post['created_at'] }}
                            </div>
                            <div class="col-md-2 text-right">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" style="right: 0 !important;">
                                        <li><a href="{{ url('dashboard/equipment/edit',$post['id'] ) }}"  class="editArticle" >Редактировать</a></li>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.deleteArticle').on("click", function(event){
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{ url('dashboard/equipment/delete') }}/" + Id,
