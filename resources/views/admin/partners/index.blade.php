...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-8">
            <h2>Партнеры</h2>
            <span>Здесь мы добавляем, удаляем и обновляем информацию о партнерах!</span>
        </div>
        <div class="col-sm-4">
            <div class="title-action">
                <a href="{{ url('dashboard/partners/new') }}" class="btn btn-primary btn-sm">Добавить</a>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="wrapper wrapper-content animated fadeInRight">
                ...
                @foreach( $data as $post )
                    ...
                    <div class="faq-item">
                        <div class="row">
                            <div class="col-md-10">
                                <a href="{{ url('dashboard/partners/edit',$post['id'] ) }}" class="faq-question">
                                    {{ $post['title'] }}
                                </a>
                            ...
                            <div class="col-md-2 text-right">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" style="right: 0 !important;">
                                        <li><a href="{{ url('dashboard/partners/edit',$post['id'] ) }}"  class="editArticle" >Редактировать</a></li>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.deleteArticle').on("click", function(event){
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{ url('dashboard/partners/delete') }}/" + Id,
