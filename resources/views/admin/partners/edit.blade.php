    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Обновляем информация о партнере!</h2>
                    <span>Здесь мы будем обновлять партнеров</span>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <div class="col-sm-12 right-side-group">
                                            ...
                                            <a href="{{ url( 'dashboard/partners/delete', $data['id'] ) }}" class="btn btn-warning">Удалить</a>
    ...
    <script>
        ...
        $(document).ready(function() {
                        ...
                        $("#form").submit(function(event){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "{{ url( "dashboard/partners/edit",$data['id'])  }}",
