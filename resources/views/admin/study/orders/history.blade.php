            ...
            <div class="wrapper wrapper-content animated fadeInRight">
                ...
                @foreach( $data as $post )
                    ...
                    <div class="faq-item">
                        <div class="row">
                            <div class="col-md-10">
                                <a href="{{ url('dashboard/study/history',$post['id'] ) }}" class="faq-question">
                                    {{ $post['name'] }}
                                </a>
                            ...
                            <div class="col-md-2 text-right">
                                <div class="btn-group">
                                    <a href="{{ url('dashboard/study/history',$post['id'] ) }}" class="btn btn-default dropdown-toggle"><i class="fa fa-cog"></i></a>
                                </div>
                            </div>
                        </div>
