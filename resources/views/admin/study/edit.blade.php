    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Обновляем курс!</h2>
                    <span>Здесь мы будем обновлять курсы</span>
                               ...
                               <div class="col-lg-3">
                                   ...
                                   <div class="form-group">
                                       <div class="col-sm-12 right-side-group">
                                           ...
                                           <a href="{{ url( 'dashboard/study/delete', $data['id'] ) }}" class="btn btn-warning">Удалить</a>
                                           <div class="progress" >
                    ...
                    $(document).ready(function() {
                        ...
                        $("#form").submit(function(event){
                            ...
                            $.ajax({
                                ...
                                url: "{{ url( "dashboard/study/edit",$data['id'])  }}",
